...
const Transactions = ({ match: { params: { address = 'd3e13d4777e22367532053190b6c6ccf57444a61337e996242b1abfb52cf92c8' } } }: Props) => {
      ...
      <div className={styles.transItems}>
        {walletTransactions &&
          ...
          walletTransactions?.transactions?.sort((a: keyable, b: keyable) => getTransactionTime(a) - getTransactionTime(b)).reverse().map(
            (transaction: keyable, index: number) => <div className={styles.transItem}
              key={index}
