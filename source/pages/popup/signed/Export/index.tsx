          ...
          {mnemonic === null
            ? <div>
              ...
              <div className={styles.checkboxCont}>
                ...
                <div className={styles.checkboxTitle}>I understand that I may lose access to digital assets if
            ...
            : <div>
              ...
              <div className={styles.mnemonicContWrap}>
                <div className={styles.mnemonicCont}>
                  {mnemonic.split(' ').map((word, index) => <div className={styles.mnemonicWords}
                    key={index}>
                    {word}
                  </div>)}
